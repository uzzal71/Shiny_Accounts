    ...
    <div class="row" id="ItemsRow">
      ...
      $this->session->unset_userdata('message')?>
			...
			<h3 align="center">Approved Leaves</h3>
            ...
            <th align="center">Action</th>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url();?>leave/printed_copy/<?php echo $each_pending_leave->id?>"><button class="btn btn-success">Print</button></a></td>
