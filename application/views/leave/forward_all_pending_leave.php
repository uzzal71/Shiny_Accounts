    ...
    <div class="row">
        <div id="custom-table" class="col-md-10 col-md-offset-1" style="background-color: #9acfea;padding: 1px;margin-left: 210px;max-height: 450px;overflow: scroll">
			...
			<h3 align="center" style = "background-color: lightblue;">Forward Leave Requests</h3>
                    ...
                    <tr>
						...
						<th align="center">Approve</th>
                            ...
                            <tr>
                                ...
                                <td><?php echo $id?></td>
                                <td><?php echo $each_pending_leave->employee_id?></td>
                                <td><?php echo $each_pending_leave->date_time_from?></td>
                                <td><?php echo $each_pending_leave->date_time_to?></td>
								<td><?php echo $each_pending_leave->no_of_days?></td>
                                <td><?php echo $each_pending_leave->leave_types?></td>
                                <td><?php echo $each_pending_leave->remarks?></td>
                                <td><?php echo $each_pending_leave->recorded_by?></td>
                                <td><?php echo $each_pending_leave->recording_time?></td>
                               
                                <td width="130px">
                                 <a href="<?php echo base_url();?>leave/forward_leave/<?php echo $each_pending_leave->id?>"><button class="btn btn-success"> Forward</button></a>
