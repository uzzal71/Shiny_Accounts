...
<div style="margin-left: 195px;margin-top: 5px;float: left">
  <a  style="margin-left: 885px;" href="<?php echo base_url();?>leave/approved_leaves" class="btn btn-primary pull-right" > Approved Leaves</a>
  <a   href="<?php echo base_url();?>leave/printed_leaves" class="btn btn-primary pull-right"> Printed Leaves</a>
...
<div style="margin-right: 5px;margin-top: 5px">
   <a  href="<?php echo base_url();?>leave/approved_leaves" class="btn btn-primary pull-right" > Approved Leaves</a>
</div>
    ...
    <div class="row" id="ItemsRow">
      ...
      $this->session->unset_userdata('message')?>
			...
			<h3 align="center">All Leave Request</h3>
            ...
            //alert(id);
                ...
                $.ajax({
                    ...
                    success: function(result) {
                      ...
                      //alert(result);
                  window.location.assign('../Leave/approve_all_pending_leave');
