...
<span  style="font-size:16px;"><p>Income  Report</p><span>
...
<tr>
<th>Sl</th><th>Income ID</th><th>Income Date</th><th>Income Amount</th><th>VAT</th><th>AIT</th><th>Project ID</th><th>Total Income</th> 
</tr>
<?php
...
<td width="100px"><?php  echo $data->vat?></td>
<td width="100px"><?php  echo $data->ait?></td>
<td width="80px" ><?php  echo $data->project_id?></td>
<td width="80px" align="right" ><?php echo $data->total_amount ?></td>
...
<tr>
<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td align="right"> <b style="margin-left:15px;">Total Income:</b> <?php echo "<b style='margin-left:0px'>".sprintf("%.2f", $all)."</b>"; ?></td>
</tr>
