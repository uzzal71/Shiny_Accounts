                    ...
                    <tr>
						...
						<th align="center">Action</th>
                            ...
                            <tr>
								...
								<td><?php
                                if(isset($each_pending_manual_attendence->ctime)){
                                    echo $each_pending_manual_attendence->ctime;
                                }?></td>
								...
								<td><?php echo "Pending"?></td>
                                  ...
                                  <a href="<?php echo base_url()?>manual_attendence/view_pending_attendence/<?php echo $each_pending_manual_attendence->id?>"> <img style="margin: 3%" border="0"
                                    ...
                                    <a href="<?php echo base_url()?>manual_attendence/forward_manual_attendence/<?php echo $each_pending_manual_attendence->id?>"><button class="btn btn-success">Forward</button></a>
