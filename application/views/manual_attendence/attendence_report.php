...
<tr>
<td colspan="1"><b>Employee ID:</b> <?php if($employee_id)echo $employee_id;?></td> <td colspan="1"><b>Employee Name:</b> <?php echo $employee_name; ?></td>
</tr>
...
if($each_attendence_report_info->status=='P')
		...
		if($each_attendence_report_info->no_of_leave_day =="0.5")
		{
			$leave = $leave + .5;
		}	 
		if($each_attendence_report_info->no_of_leave_day =="1")
		{
			$leave = $leave++;
			$full_day_leave++;
		}	
...
<?php $flag_time=strtotime($in_time); 

if ($flag_time=="1518372000"){
	$out_time="00-00-00";
}elseif ($flag_time!=="1518372000") {
	
	if ($in_time==$out_time) {
		$out_time="00-00-00";
		$remarks="No Exit Entry Found";
	}
}
?>
...
<td><?php echo $status;  if( $status=="W"){
...
$total_absent = $total_working_day - $total_present - $full_day_leave;
?>
<tr>
...
<tr>
<td><b>Total Absent</b></td> <td>:</td> <td><?php echo $total_absent?></td> 
</tr>
<tr>
...
<tr><td></td></tr>
<tr>
	<td style="color: red"><b>Abbreviations</b></td>
</tr>
<tr>
<td>W= Weekend</td><td>A= Absent</td><td>L=Late</td>
</tr>
<tr>
<td>P= Present</td><td>CL= Casual Leave</td><td>EL=Earn Leave</td>
</tr>
</table>
