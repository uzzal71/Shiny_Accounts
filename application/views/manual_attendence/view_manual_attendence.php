                ...
                <table id="" class="table ">
                    ...
                    <tr>
                        ...
                        <td align="center"style="" colspan="">                           
                            <select name="employee_id" class="form-control col-sm-3 custom-input" id="employee_id" disabled>
                       ...
                       <td colspan="">
                            <input type="text"class="form-control  custom-input dateTimeFrom" value = "<?php echo $each_pending_manual_attendence->date?>" id="date" name="date" readonly >
                       </td>    
                    ...
                    <tr>
                       ...
                       ?>
                            ...
                            <input type="text" class="form-control  custom-input" value ="<?php echo date('H:i',$dates);?>" id="in_time"  name="in_time" required readonly >
                       </td>  
                       <th align="center">Out Time</th>
                       <td align="center" style="width:30%">
                        <?php $date=strtotime($each_pending_manual_attendence->out_time); ?>
                            <input type="text" class="form-control" value ="<?php echo date('H:i',$date);?>" custom-input"  id="out_time" name="out_time" required  readonly >
                        </td>                          
                    ...
                    <tr>
                       ...
                       <td colspan="">
                            <select name="under_consideration" class="form-control col-sm-3 custom-input" id="under_consideration" disabled >
                            <option value="select" >select</option>
                                <?php foreach($all_employee as $each_employee){?>
                       ...
                       <td align="center"style="width:30%">
                       <input type="text" value = "<?php echo $each_pending_manual_attendence->remarks?>" id="remarks" name="remarks" class="form-control custom-input" required readonly >
