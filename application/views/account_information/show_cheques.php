    ...
    <div class="row" style="background-color: white;">
        <div  class="col-md-10 col-md-offset-1" style="padding: 1px;margin-left: 210px;">
            <div >
			<h3 align="center" > Cheque Book Pages List For Account No:<?php echo $account_no; ?></h3>
            ...
            <th align="center">Account Number</th>
                        ...
                        <th align="center">Already Issued</th>
              ...
              foreach($accounts_cheques as $cheques){
                $serial_no++?>
                            <tr>
                                ...
                                <td><?php echo $cheques->account_no?></td>
                                <td style="text-align: left; "><?php echo $cheques->cheque_no?></td>
                                
                
                                
                                 <td><?php 
                                 $used=$cheques->is_used;
                                 if ($used=='1') {
                                   echo "Yes";
                                 }else{
