<br></br>
    <div class="row" id="myDiv">
        <div class="col-md-7 col-md-offset-3">
            ...
            <div class="panel panel-primary custom-panel">
                ...
                <div class="panel-heading">Payment Recipient Entry(Miscellaneous)</div>
  ...
  <div class="form-group" style="min-height: 50px;">
   ...
   ?>
    ...
    <input type="text" class="form-control" id="recipient_id" name="recipient_id" value="<?php echo 'MRI'.date('Y').$recipient_id; ?>" readonly>
  </div>
   <div class="form-group" style="min-height: 50px;">
    <label for="recipient_name" style="min-width: 110px;">Recipient Name:*</label>
    <input type="text" class="form-control" id="recipient_name" name="recipient_name" class="recipient_name">
  </div>
  <div class="form-group" style="min-height: 50px;">
...
$("#submit").click(function(){
			...
			$.ajax({
					async: false,
					type: 'POST',
					url: '<?php echo base_url();?>Account_information/save_payment_recipient_entry',
					data:{ 
