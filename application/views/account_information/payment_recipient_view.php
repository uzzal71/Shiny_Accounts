<br></br>
  ...
  <div class="form-group" style="min-height: 50px;">
   ...
   <div class="form-group" style="min-height: 50px;">
    ...
    <input type="text" class="form-control" id="recipient_name" name="recipient_name" class="recipient_name" value="<?php echo $recipient_data->recipient_name ?>" readonly >
  </div>
  <div class="form-group" style="min-height: 50px;">
    <label for="debited_amount" style="min-width: 110px;">Contact:*</label>
    <input type="text" class="form-control" id="contact"  value="<?php echo $recipient_data->contact ?>" readonly >
  </div>
 <div class="form-group" style="min-height: 50px;">
    <label for="payment_method"  style="min-width: 110px;">Company Name:*</label>
    
    <input type="text" class="form-control" id="company_name"  value="<?php echo $recipient_data->company_name ?>" readonly >
  </div>
 	
 	   <div class="form-group" style="min-height: 50px;">
    <label for="designation"  style="min-width: 110px;">Designation:*</label>
    <input type="text" class="form-control" id="designation"  value="<?php echo $recipient_data->designation ?>" readonly >
  </div>

      <div class="form-group" style="min-height: 50px;">
    <label for="remarks"  style="min-width: 110px;">Remarks:</label>
    <input type="text" class="form-control" id="remarks"  value="<?php echo $recipient_data->remarks ?>" readonly >
