        ...
        <div class="col-md-6 col-md-offset-3">
			...
			<td> <select id="from_account" name="from_account" class="form-control custom-input">
				...
				<?php foreach ($accounts as  $account) { ?>
					<option value="<?php echo $account->account_no?>" <?php if ($balance_transfer_data->from_account==$account->account_no) {
						echo "Selected";
					} ?>><?php echo $account->account_no?></option>
				<?php } ?>
			...
			<td > <select id="to_account" name="to_account" class="form-control custom-input">
					<option value="select">Select Account</option>
				<?php foreach ($accounts as  $account) { ?>
					<option value="<?php echo $account->account_no?>" <?php if ($balance_transfer_data->to_account==$account->account_no) {
						echo "Selected";
					} ?>><?php echo $account->account_no?></option>
				<?php } ?>
			...
			<td> <br>: <br> &nbsp;</td>
			<td > <input type="number"  step="0.01" min="0" id="amount" name="amount" class="form-control custom-input"  value="<?php echo $balance_transfer_data->requested_amount; ?>" required></td>
			...
			<td> <br>: <br> &nbsp;</td>
			<td colspan="1"> <input type="text"   id="remarks" name="remarks" class="form-control custom-input"  value="<?php echo $balance_transfer_data->remarks; ?>" required></td>
			<td> <label for="branch" style="margin-top: 4px">&nbsp;Reference</label></td>
			<td> <br>: <br> &nbsp;</td>
			<td> <input type="text"   id="reference" name="reference" class="form-control custom-input" value="<?php echo $balance_transfer_data->reference; ?>" required>
