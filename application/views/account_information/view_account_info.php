    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-3">
            <div class="panel panel-primary custom-panel">
                <div class="panel-heading">View Account Information</div>
                ...
                <table id="" class="table ">
					...
					<tr>
                       ...
                       <td width="30%">                   
					   <input type="text" id="account_name" value = "<?php echo $each_account_info->account_name?>" name="account_name" class="form-control custom-input " readonly required>
					   </td width="30%">  
					   <th align="center">Account No</th>
                       <td align="center">
						<input type="text" id="account_no" value = "<?php echo $each_account_info->account_no?>" readonly name="account_no" class="form-control custom-input ">
					   </td>					   
					...
					<tr>
                       ...
                       <td align="center">
						<input type="text" class="form-control input" readonly value="<?php echo $each_account_info->emp_id?>">
					   </td>  
					   <th align="center">Bank Name</th>
                       <td align="center">
						<input type="text" id="bank_name" value = "<?php echo $each_account_info->bank_name?>"  readonly name="bank_name" class="form-control custom-input ">
					   </td>					   
                    ...
                    <tr>
                       ...
                       <td width="30%">                   
					   <input type="text" id="branch" value = "<?php echo $each_account_info->branch?>" name="branch" readonly class="form-control custom-input " required>
					   </td width="30%">  
					   <th align="center">Address</th>
                       <td align="center">
						<input type="text" id="address" value = "<?php echo $each_account_info->address?>" readonly name="address" class="form-control custom-input ">
					   </td>					   
                     ...
                     <tr>
                       ...
                       <td width="30%">                   
					   <input type="text" id="bank_contact_no" value = "<?php echo $each_account_info->bank_contact_no?>" name="bank_contact_no" class="form-control custom-input " readonly required>
					   </td width="30%">  
					   <th align="center">Opening Date</th>
                       <td align="center">
						<input type="text" id="opening_date" value = "<?php echo $each_account_info->opening_date?>" readonly name="opening_date" class="form-control custom-input dateFrom">
					   </td>					   
                    ...
                    <tr>
                       ...
                       <td width="30%">                   
					   <input type="text" id="introducer_name"  value = "<?php echo $each_account_info->introducer_name?>" readonly name="introducer_name" class="form-control custom-input " required>		
					      <input type="hidden" id="id" name="id" value = "<?php echo $each_account_info->id?>" class="form-control custom-input " >
					   </td width="30%">  
					   <th align="center">Balance</th>
                       <td align="center">
						<input type="text" id="balance" name="balance" class="form-control custom-input balance" readonly value="<?php echo sprintf("%.2f", $each_account_info->balance) ?>">
					   </td>					   
