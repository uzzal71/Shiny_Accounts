...
<div style="margin-left: 195px;margin-top: 5px;float: left">
    <a href="<?php echo base_url();?>Voucher_entry/printed_vouchers" class="btn btn-primary pull-right">Printed Vouchers</a>
</div>
<div style="margin-right: 25px;margin-top: 5px">
    <a href="<?php echo base_url();?>Voucher_entry/printed_and_approved_vouchers" class="btn btn-primary pull-right">Approved & Printed Vouchers</a>
</div>
    ...
    <div class="modal-content">
        ...
        <table border="0">
            ...
            <input type="hidden" id="v_iid">
                ...
                <tr>   
                    ...
                    <td>&nbsp;&nbsp;<input type="text" id="created_at" style="border: 0;color: #010047" readonly ></td>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
         <button type="button" class="btn btn-primary" id="voucher_approve" disabled>Approve</button>
      </div>
    </div>
