 ...
 <form role="form" action="<?php echo base_url();?>voucher_entry/update_bill_info_all_ready_approved" method="post">
...
<?php 
  ...
  <div class="form-group  col-md-1">
                    ...
                    <p>
                        ...
                        <button type="submit" id="submit_button" name="" class="btn btn-primary">Update</button>
                    </p>
                    </div>
                    </fieldset>
                      </div>
