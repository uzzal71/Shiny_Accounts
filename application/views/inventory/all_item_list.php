...
<div style="background-color: white">
  <form method="post" action="<?php echo base_url();?>Inventory/view_on_type_base">
    <div class="row" style="margin-left: 550px;">
      <label>Select Item Type</label>
      <select id="item_type" name="item_type" style="min-width: 180px">
        <option value="all">All</option>
        <?php foreach ($all_item_types as $item_types) { ?>
        
        <option value="<?php echo$item_types->type_id ?>" <?php if ($item_types->type_id==$item_type) {
         echo "Selected";
        ...
        <div  class="col-md-10 col-md-offset-1" style="padding: 1px;margin-left: 210px;">
            ...
            <th align="center">Item ID</th>
              ...
              foreach($items_data as $each_item){
                ...
                <td>
                  <img src="<?php echo base_url();?><?php echo $each_item->item_image?>" width="50px" height="50px">
                </td>
