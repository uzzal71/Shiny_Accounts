...
<span  style="font-size:16px;"><p>Master Inventory Report</p><span>
...
<tr>
<th>Sl</th><th>Item ID</th><th>Item Name</th> <th>Current Stock</th> <th>WIP Quantity</th><th>Assigned Qauntity </th><th>Total Quantity</th><th>Unit Price</th><th>Total Price</th><th>UoM</th> <th>Remarks</th>
</tr>
<?php
...
foreach ($materials_data as $each_item){
	$sl++;
$currentquantity=$each_item->quantity;
$wipquantity=$each_item->wip_quantity;
$assignedquantity=$each_item->assigned_quantity;
$total=$currentquantity+$wipquantity+$assignedquantity;
...
<td><?php  echo $each_item->wip_quantity?></td>
<td><?php  echo $each_item->assigned_quantity?></td>
<td><?php  echo $total?></td>
<td><?php  echo $each_item->unit_price?></td>
<?php $total_price=$total*$each_item->unit_price ?>
