...
<span  style="font-size:16px;"><p>Requisiton Report</p><span>
...
<tr>
<th>Requisition ID</th><th>Item Name</th><th>Item ID</th> <th>Quantity</th> <th>UoM</th> <th>Remarks</th><th>Status</th>
</tr>
<?php
...
foreach ($recieve_requisition_report_info as $each_requisition_info){
	$sl++;
?>
<tr >
<th style="background-color: #4CAF50"><?php echo $each_requisition_info->requisition_no?></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"><?php echo $each_requisition_info->requisition_status ?></th>
</tr>
<?php 

$requisition_info =json_decode ($each_requisition_info->requisition_info);

print_r($requisition_info);exit();
foreach ($requisition_info as $requ_info){?>
<tr>
<td></td>
<td><?php  echo $requ_info->item_name?></td>
<td><?php  echo $requ_info->item_id?></td>
<td><?php  echo $requ_info->quantity?></td>
<td><?php  echo $requ_info->uom?></td>
<td><?php  echo $requ_info->remarks?></td>
