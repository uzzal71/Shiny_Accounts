...
<span  style="font-size:16px;"><p>Damage  Report</p><span>
				
</td>
</tr>

<tr>
<td colspan="1"><b>From:</b> <?php if($from_date) echo $from_date;?></td>  <td colspan="1"><b>To Date:</b> <?php echo $to_date?> </td><!-- <td><b>Employee Name:<?php echo $recieve_issue_report_info['employee_id']?></b></td>> -->
</tr>


<tr>
<th>Requisition ID</th><th>Item Name</th><th>Item ID</th> <th>Quantity</th> <th>UoM</th><th>Issue Type</th><th>Remarks</th>
</tr>
<?php
...
foreach ($damaged_data as $each_damage_data){
	$sl++;
?>
<tr >
<th style="background-color: #4CAF50"><?php echo $each_damage_data->damage_no?></th><th style="background-color: #4CAF50">Employee ID:<?php echo $each_damage_data->employee_id ?></th><th style="background-color: #4CAF50">Project ID:<?php echo $each_damage_data->project_id ?></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"></th>
</tr>
<?php 

$damage_info =json_decode ($each_damage_data->damage_info);

foreach ($damage_info as $key => $each_damage) {?>
<tr>
<td></td>
<td><?php  echo $each_damage->item_name?></td>
<td><?php  echo $each_damage->item_id?></td>
<td><?php  echo $each_damage->quantity?></td>
<td><?php  echo $each_damage->uom?></td>
<td></td>
<td><?php  echo $each_damage->cause_of_damage?></td>
