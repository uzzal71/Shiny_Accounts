...
<span  style="font-size:16px;"><p>Inventory  Report</p><span>
...
<tr>
<th>Sl</th><th>Item Name</th><th>Item ID</th> <th>Quantity</th> <th>UoM</th><th>Unit Price</th><th>Remarks</th>
</tr>
<?php
...
foreach ($recieve_item_info_for_report as $each_item){
	$sl++;
?>
<tr >
<td><?php echo $sl?></td>
