...
<span  style="font-size:16px;"><p>Issue  Report</p><span>
...
foreach ($recieve_issue_report_info as $each_issue_info){
	$sl++;
?>
<tr >
<th style="background-color: #4CAF50"><?php echo $each_issue_info->issue_id?></th><th style="background-color: #4CAF50">Employee ID:</th><th style="background-color: #4CAF50"><?php echo $each_issue_info->employee_id ?></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"></th><th style="background-color: #4CAF50"><?php echo $each_issue_info->issue_type ?></th><th style="background-color: #4CAF50"></th>
</tr>
<?php 

$requisitin_info =json_decode ($each_issue_info->issue_info);

foreach ($requisitin_info as $key => $issue_info) {?>
<tr>
<td></td>
...
<td></td>
<td><?php  echo $issue_info->remarks?></td>
