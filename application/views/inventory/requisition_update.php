 ...
 <form role="form" name="requisition" action="<?php echo base_url();?>inventory/update_requisition" method="post">
					  ...
					  <th align="center" style="min-width: 120px">Poject ID*</th>
					    ...
					    <option value="select" selected>Select Project ID</option>
					     <!-- <option value="<?php echo $requisition_data->project_id?>" selected> --><?php echo $requisition_data->project_id?></option>
										...
										<option value="<?php echo $project->project_id;?>" <?php if ($project->project_id==$requisition_data->project_id) {
											echo "Selected";
										} ?>><?php echo $project->project_id;?></option>
										<?php }?>
                    ...
                    <td>Requisition Type*</td>
					    ...
					    <option  value="">Select Requisition Type</option>
					    	...
					    	<option value="general_issue" <?php  if ($requisition_data->issue_type=="general_issue") {
 							...
 							<td>Poject Name</td>
					     <td><input type="text" name="project_name" id="project_name" class="form-control custom-input project_name" value="<?php echo $project_infos ?>" ></td>
...
<div id="entry1" class="clonedInput row">
 ...
 <div class="col-md-1 currentstockDiv" style="padding: 1px;min-width: 120px;" >
  ...
  <div class="col-md-2 remarksDiv" style="padding: 1px;">
  	...
  	<th><input type="text" value="<?php echo $requisition_items->remarks?>" name="remarks[]" id="remarks" class="form-control remarks"></th>
  </div>
...
$('.js-example-basic-single').select2();
	...
	$("#project_id").on('change',function(){
		...
		$("#project_id").change(function(){
			...
			var project_description = project_info[3];
			//alert(project_description);

			var final_word=project_name+' - '+project_description
			$('#project_name').val(final_word);
