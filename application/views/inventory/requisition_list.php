    ...
    <div class="row">
        <div id="custom-table" class="col-md-10 col-md-offset-1" style="background-color: #9acfea;padding: 1px;margin-left: 210px;max-height: 450px;overflow: scroll">
			...
			<h3 align="center" style = "background-color: lightblue;"> Requisition List</h3>
                            ...
                            <tr>
                               ...
                               <td width="130px">
                                    ...
                                    src="<?php echo base_url();?>images/details.png" width="25" height="20"></a> 
									 <a href="<?php echo base_url();?>Inventory/requisition_update/<?php echo $each_requisition->id?>"> <img style="margin: 3%" border="0"
                                    title="Edit User Info" alt="Edit"src="<?php echo base_url();?>images/edit.png" width="25" height="20"></a>
                                   
                                   <a href="<?php echo base_url();?>Inventory/requisition_delete/<?php echo $each_requisition->id?>" onclick="return confirm('Are you sure?')">
