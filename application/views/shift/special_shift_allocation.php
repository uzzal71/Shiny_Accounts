    ...
    <div class="row">
		...
		<div id="custom-table" class="panel panel-primary custom-panel" style="background-color: ;padding: 1px;margin-left: 210px;max-height: 450px;overflow: scroll">
			<div class="panel-heading">Create Special Shift Allocation</div>
            <div class="table-responsive" id="custom-table">
                ...
                <table id="" class="table ">
					...
					<tr>
                       ...
                       <td align="center">
                        <select required name="shift_id" class="form-control col-sm-6 custom-input" id="shift_id">
							<option value="select">select</option>
					...
					<tr>
                        <th></th> <th></th> <th></th>
                       <td font-size="24"><input type=""id="btn_special_shift" class="btn btn-success" value="Create Special Shift Allocation"/></td>                      
		...
		$("#btn_special_shift").click(function(){
			...
			if(form_validation())
			{
				...
				$.ajax({
					async: false,
					type: 'POST',
					url: '<?php echo base_url();?>Shift/save_special_shift_allocation',
					data:{ 
							date: date,
