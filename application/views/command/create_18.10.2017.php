...
.modal-body {
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
                ...
                <br>
                    ...
                    <div class="col-xs-12 col-sm-10 col-md-10">
					  ...
					  <form name="save_command" class="form-horizontal"  action="<?php echo base_url(); ?>Command/save_new_command" method="post">	
                        ...
                        <select required name="actionCode" class="form-control col-sm-6 custom-input" id="userType">
            ...
            <button type="submit" class="btn btn-info pull-left pull-right">Submit Command</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href= "<?php echo base_url();?>Device/add_new_device" target = "_blank">
                                            <button type= "button" class="btn btn-info">Create Device</button>
                                        </a>
                                    </td>

                                    <td>
                                        <a href= "<?php echo base_url();?>Employee/create" target = "_blank">
                                            <button type= "button" class="btn btn-info">Create Employee</button>    
                                        </a>
                                    </td> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href= "<?php echo base_url();?>Device/device_list" target = "_blank">
                                            <button type= "button" class="btn btn-info">Update Device</button>
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href= "<?php echo base_url();?>Schedule/schedule_list" target = "_blank">
                                            <button type= "button" class="btn btn-info">Update Schedule</button>
                                        </a>
                                    </td>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        ...
                                        <a data-toggle="modal" href="#" data-target="#myModal_device">
                                            <button type= "button" class="btn btn-info">Device Delete</button>
                                        </a>
                                    </td>

                                    <td>
                                        <a data-toggle="modal" href="#" data-target="#myModal">
                                            <button type= "button" class="btn btn-info pull-left">Employee Delete</button>
                                        </a>
                                    <td>
