<br><br>
    <div class="row">
        <div id="custom-table" class="col-md-10 col-md-offset-1" style="background-color: #9acfea;padding: 1px;margin-left: 210px;max-height: 450px;overflow: scroll">
			...
			<h3 align="center" style = "background-color: lightblue;">Approve Increment<br><br></h3>
			<table>
			<thead>
			<tr style="margin:10;">
			<td>Date From</td>
			...
			<td><button type="submit" value="" class="btn btn-primary" id="promotion_list">Increment List</button></td>
			</tr>
			</thead>
			</table>
                <table class="table table-bordered" id= "table_id">
                    ...
                    <tr>
                        ...
                        <th align="center">Incremented Salary</th>
		...
		$("#promotion_list").click(function(){
			...
			if(form_validation())
			{
				...
				$.ajax({
					async: false,
					type: 'POST',
					url: '<?php echo base_url();?>Increment/search_increment',
					data:{ 
							date_from: date_from,
							date_to: date_to
