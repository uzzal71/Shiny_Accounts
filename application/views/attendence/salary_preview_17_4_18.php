...
$all_employees = $this->Attendence_model->select_employee_info_by_employee_ids($employee_ids);
    ...
    <tr>
        ...
        <td><select name="account" id="account" class="account">
          
            <option value="bank">Bank</option>
            <option value="cash">Cash</option>
        </select></td>
        <td><input type= "checkbox" id = "checkbox" name = "checkbox" checked class="checkbox" value="<?php echo$employee_id; ?>" ></input></td>
