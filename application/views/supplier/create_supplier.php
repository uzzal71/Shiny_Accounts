            ...
            <div class="table-responsive" id="custom-table">
                ...
                <table id="" class="table ">
                    ...
                    <tr>
                       ...
                       <td align="center"style="width:30%"><input type="text" name="supplier_id" value="<?php echo "SL".date('Y').$last_id?>" id="supplier_id" class="form-control custom-input" readonly required></td>                        
					...
					<tr>
                       ...
                       <td align="center"style="width:30%"><input type="text" name="supplier_address" value="" id="supplier_address" class="form-control custom-input" required></td>                        
					...
					<tr>
                       ...
                       <td align="center"style="width:30%"><input type="text" name="supplier_contact" value="" id="supplier_contact" class="form-control custom-input" required></td>                        
					...
					<tr>
                       ...
                       <td align="center"style="width:30%"><input type="text" name="supplier_designation" value="" id="supplier_designation" class="form-control custom-input" required></td>                        
					...
					<tr>
                       ...
                       <td align="center"style="width:30%"><input type="text" name="supplier_email" value="" id="supplier_email" class="form-control custom-input" required></td>                        
					...
					<tr>
                       ...
                       <td align="center"style="width:30%"><input type="text" name="supplier_mobile" value="" id="supplier_mobile" class="form-control custom-input" required></td>                        
					...
					<tr>
                       ...
                       <td align="center"style="width:30%"><input type="text" name="supplier_phone" value="" id="supplier_phone" class="form-control custom-input" required></td>                        
					...
					<tr>
                       ...
                       <td><button type="submit" id="btn_create_supplier" class="btn btn-info pull-right">Add New supplier</button></td>                        
		...
		$("#btn_create_supplier").click(function(){
			...
			if(form_validation())
			{
				...
				$.ajax({
					async: false,
					type: 'POST',
					url: '<?php echo base_url();?>supplier/save_new_supplier',
					data:{ 
							full_name: full_name,
