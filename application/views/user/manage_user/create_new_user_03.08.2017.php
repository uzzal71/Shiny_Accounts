                ...
                <table id="" class="table ">
					...
					<tr>
                       <td  style="text-align:left" colspan="2">
							...
							<label><input type="checkbox" name="user_role[]" id="<?php echo $each_user_role->id;?>" class="checkBoxClass" value="<?php echo $each_user_role->id;?>"> <?php echo $each_user_role->user_role_name;?></label>
							<br> 
							<?php }?>
					...
					<tr>
                       <td align="center" colspan="">
								<label for="ckbCheckAll">&nbsp Select All Roles</label>  <input class="check-all" type="checkbox" name="" id="ckbCheckAll">
                                  
					   </td>	
					   <td></td>				   
					   <td align="center" colspan="">
								<label for="ckbCheckAllCompany">&nbsp Select All Companies</label>  <input class="check-all-company" type="checkbox" name="" id="ckbCheckAllCompany">
