...
<span  style="font-size:16px;"><p>Employee Report</p><span>
...
<tr>
								...
								<td><?php echo $each_employee_report_info->first_name." ".$each_employee->last_name?></td>
...
<form method="post" name="excel" id="excel" action="#"  target="_blank">
...
<form method="post" name="pdf" id="pdf"   action="#"  target="_blank">
<input type="hidden" name="all_department" value = "<?php echo $all_department;?>">
<input type="hidden" name="department_name" value = "<?php echo $department_name;?>">
</form>
