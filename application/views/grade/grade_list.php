    ...
    <div class="row">
        <div id="custom-table" class="col-md-10 col-md-offset-1" style="background-color: #9acfea;padding: 1px;margin-left: 210px;max-height: 450px;overflow: scroll">
			...
			<h3 align="center" style = "background-color: lightblue;"> Grade List</h3>
                        ...
                        <th align="center">Action</th>
							...
							foreach($all_grade as $each_grade){
								...
								<tr>
									...
									<td><?php echo $each_grade->grade_name?> </td>
									<td><?php echo $each_grade->description?> </td>
									
									<td width="130px">
										<a href="<?php echo base_url()?>Grade/edit_grade/<?php echo $each_grade->id; ?>"> <img style="margin: 3%" border="0"
										title="Edit User Info" alt="Edit"src="<?php echo base_url();?>images/edit.png" width="25" height="20"></a>
										<a href="<?php echo base_url()?>Grade/delete_grade/<?php echo $each_grade->id; ?>" id="" onclick="return confirm('Are you sure?')">
