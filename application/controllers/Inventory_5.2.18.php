...
public function update_item_info() {
       ...
       // print_r($_POST);exit();
		...
		$result=$this->Inventory_model->update_items_info($id,$data);
				if ($result) {
...
$query_result=$this->Inventory_model->save_new_requisition_request($data);
    ...
    alert("Requisition  Received Successfully");
 				...
 				<?php  redirect('Inventory/requisition_form','refresh');
        	}
...
redirect('Inventory/product_list','refresh');	
