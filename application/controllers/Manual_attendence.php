...
class Manual_attendence extends CI_Controller {
	...
	public function manual_attendence_entry()
	{
		 ...
		 //$data['all_grade_A_employee']=$this->Employee_model->select_all_grade_a_employee_list($company_id);
	...
	//print_r($_POST);
		...
		$data['in_time']=$date.' '.$in_time;
		$data['out_time']=$date.' '.$out_time;
		//print_r($data);exit();

		$check_duplicate=$this->Manual_attendence_model->check_manual_attendence_if_exists($company_id,$employee_id,$data['in_time'],$data['out_time']);



		//print_r($check_duplicate);exit();
		if ($check_duplicate) {
		...
		if($in_time !="" && $out_time !="" )
		{
			...
			$save_attendence = $this->Manual_attendence_model->save_employee_attendence_info_manual($data);
			//print_r($save_attendence);exit();
			 if($save_attendence)
			 {
		 	echo "Attendance sent for Consideration";
		 }
		 else
		 {
		 	echo "Not Saved";
	...
	public function all_pending_manual_attendence()
	{
		 $data = array();
         $data['title']="2RA Technology Limited";
         $data['keyword']="";
		 ...
		 $data['all_pending_manual_attendence']=$this->Manual_attendence_model->view_all_pending_manual_attendence_info($company_id);
		...
		public function all_pending_manual_attendence_list()
	{
		 $data = array();
         $data['title']="2RA Technology Limited";
         $data['keyword']="";
		 ...
		 $company_id = $this->session->userdata('company_id');
		 $employee_id = $this->session->userdata('user_name');
		 $data['all_pending_manual_attendence_list']=$this->Manual_attendence_model->view_all_pending_manual_attendence_list_info($company_id);
         $data['maincontent'] = $this->load->view('manual_attendence/all_pending_manual_attendence_list.php',$data, true);
		
        $this->load->view('master', $data);
        
	}	
	public function pending_manual_attendence_list()
	{
		 $data = array();
         $data['title']="2RA Technology Limited";
         $data['keyword']="";
		 ...
		 $data['all_pending_manual_attendence']=$this->Manual_attendence_model->select_all_pending_manual_attendence_info($company_id);
         $data['maincontent'] = $this->load->view('manual_attendence/approve_manual_attendence_list.php', $data, true);
	...
	public function approve_manual_attendence($id)
	{
		...
		$attendance_info=$this->Manual_attendence_model->view_each_pending_manual_attendence_info($id,$company_id);

		$data['company_id']=$company_id;
		$data['employee_id']=$attendance_info->employee_id;
		$data['card_id']=$attendance_info->card_id;
		$data['employee_name']=$attendance_info->employee_name;
		$data['ctime']=$attendance_info->in_time;
		$data['under_consideration']=$attendance_info->under_consideration;
		$data['device_id']=$attendance_info->device_id;
		$data['status']=1;
		$data['remarks']=$attendance_info->remarks;
		$data['entry_time']=date("y-m-d h:i:s");
		$data['sl_no']='1';
		$data['purpose']='Entry';
		//print_r($attendance_info);exit();
		$datas['company_id']=$company_id;
		$datas['employee_id']=$attendance_info->employee_id;
		$datas['card_id']=$attendance_info->card_id;
		$datas['employee_name']=$attendance_info->employee_name;
		$datas['ctime']=$attendance_info->out_time;
		$datas['under_consideration']=$attendance_info->under_consideration;
		$datas['device_id']=$attendance_info->device_id;
		$datas['status']=1;
		$datas['remarks']=$attendance_info->remarks;
		$datas['entry_time']=date("y-m-d h:i:s");
		$datas['sl_no']='1';
		$datas['purpose']='Entry';
	
		 $approve_manual_attendence =$this->Manual_attendence_model->save_employee_attendence_info($data);

		  $approve_manual_attendences =$this->Manual_attendence_model->save_employee_attendence_info($datas);

		 $update_manual_attendence= $this->Manual_attendence_model->approve_manual_attendence_info($id,$company_id);
         if($update_manual_attendence){
			// alert("Approved");
			 redirect('Manual_attendence/pending_manual_attendence_list');
		 }
		 else{
			// alert("Not Approved");
			 redirect('Manual_attendence/pending_manual_attendence_list');
	...
	public function edit_pending_attendence($id)
	{
		...
		// print_r($company_id);
		// exit();
		 $data['each_pending_manual_attendence']=$this->Manual_attendence_model->view_each_pending_manual_attendence_info($id,$company_id);
	...
	public function view_pending_attendence($id)
	{
		 $data = array();
         $data['title']="2RA Technology Limited";
         $data['keyword']="";
		...
		// exit();
		 $data['each_pending_manual_attendence']=$this->Manual_attendence_model->view_each_pending_manual_attendence_info($id,$company_id);
         $data['maincontent'] = $this->load->view('manual_attendence/view_manual_attendence.php', $data, true);
	...
	public function update_pending_manual_attendence()
	{
	...
	//print_r($_POST);
		//exit();
		 ...
		 //exit();
		 	...
		 	$check_duplicate=$this->Manual_attendence_model->check_manual_attendence_if_exists_while_update($company_id,$employee_id,$data['in_time'],$data['out_time'],$id);
		 ...
		 $update_pending_manual_attendence = $this->Manual_attendence_model->update_pending_manual_attendence_info($data,$id,$company_id);
		 if($update_pending_manual_attendence){
			  echo "Updated";
		 }
		 else{
			  echo "Fail to update";
	...
	public function delete_manual_attendence($id) {
		...
		redirect('Manual_attendence/all_pending_manual_attendence_list');
  ...
  public function show_in_out_report_pdf()
	...
	public function forward_manual_attendance_list(){
		 ...
		 $data['all_pending_manual_attendence']=$this->Manual_attendence_model->select_all_pending_manual_attendence_info_forward($company_id);
         $data['maincontent'] = $this->load->view('manual_attendence/forward_manual_attendance.php', $data, true);
	...
	public function forward_manual_attendence($id)
	{
		 $data = array();
		 $company_id = $this->session->userdata('company_id');
		 $data['status'] = "2";
         ...
         if($approve_manual_attendence){
			// alert("Approved");
			 redirect('Manual_attendence/forward_manual_attendance_list');
		 }
		 else{
			// alert("Not Approved");
			 redirect('Manual_attendence/forward_manual_attendance_list');
	...
	public function edit_forwarded_attendence($id)
	{
		 $data = array();
         $data['title']="2RA Technology Limited";
         $data['keyword']="";
		...
		// print_r($company_id);
		// exit();
		 $data['each_pending_manual_attendence']=$this->Manual_attendence_model->view_each_forwarded_manual_attendence_info($id,$company_id);
         $data['maincontent'] = $this->load->view('manual_attendence/edit_forwarded_attendence.php', $data, true);
   	...
   	public function forwarded_manual_attendance_list(){
		 ...
		 $data['all_pending_manual_attendence']=$this->Manual_attendence_model->select_all_pending_manual_attendence_info_forwarded($company_id);
         $data['maincontent'] = $this->load->view('manual_attendence/forwarded_manual_attendance_list.php', $data, true);
	...
	public function update_forwarded_manual_attendence()
	{
		...
		//print_r($_POST);
         ...
         $employee_name = $employee_info->first_name." ".$employee_info->last_name;
         $data['employee_name'] = $employee_name;
         $data['ctime'] = $this->input->post('ctime', true);
		 $data['under_consideration'] = $this->input->post('under_consideration', true);
		 $data['remarks'] = $this->input->post('remarks', true);
		 $data['status'] = "2";
		 $data['updated_at'] = date("y-m-d h:i:s");
		...
		public function my_forwarded_manual_attendance_list(){
		 ...
		 $data['all_pending_manual_attendence']=$this->Manual_attendence_model->my_all_pending_manual_attendence_info_forwarded($company_id);
         $data['maincontent'] = $this->load->view('manual_attendence/my_forwarded_manual_attendance_list.php', $data, true);
